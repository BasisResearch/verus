...
pub use crate::provenance::{
    QueryDifficulty, QueryInstPressure, QueryProvenance, ResolvedDifficultyRow,
    ResolvedInstantiation, ResolvedQuantPressure, ResolvedQueryDifficulty,
...
impl Verifier {
    ...
    fn verify_crate_inner(
        ...
        // Join what cvc5 reported (instantiation pressure, difficulty,
        // provenance) back to source, per function. The joins read the same
        // symbols.
        if self.args.inst_pressure || self.args.difficulty || self.args.provenance {
