...
pub(crate) enum Attr {
    ...
    UnerasedProxy,
    UsesUnerasedProxy,
    // An explicit root of the static reachability report (`--reach`)
    ReachRoot,
    EncodedConst,
    EncodedStatic,
...
pub(crate) struct VerifierAttrs {
    ...
    /// `#[verifier::reach_root]`: a root of the static reachability report
    pub(crate) reach_root: bool,
...
pub(crate) fn get_verifier_attrs_maybe_check(
    ...
    for attr in parse_attrs(attrs, diagnostics)? {
        match attr {
            ...
            Attr::ReachRoot => vs.reach_root = true,
